...
res_EpiEstim <- fct_EpiEstim(I0 = sim$I0 , I = sim$res$I_true , #I_obs, #I_true ,
                             t_window = t_window, 
...
res_MCMC_EpiEstim_Poiss1 <- fct_MCMC_EpiEstim(I0 = sim$I0 , I = sim$res$I_true , #I_obs, #I_true , #
                                              t_window = t_window,
                                             mean_prior = mean_prior, std_prior = std_prior,
                                             res_EpiEstim = res_EpiEstim, overdispersion = FALSE, 
                                             rep = rep, thin = 10, param_agg = FALSE)

res_MCMC_EpiEstim_Poiss2 <- fct_MCMC_EpiEstim(I0 = sim$I0 , I = sim$res$I_true , #I_obs, #I_true , 
                                              t_window = t_window,
                                             mean_prior = mean_prior, std_prior = std_prior,
                                             res_EpiEstim = res_EpiEstim, overdispersion = FALSE, 
...
res_MCMC_EpiEstim_NB1 <- fct_MCMC_EpiEstim(I0 = sim$I0 , I = sim$res$I_true , #I_obs,#I_true  ,
                                           t_window = t_window,
                                          mean_prior = mean_prior, std_prior = std_prior,
...
res_MCMC_EpiEstim_NB2 <- fct_MCMC_EpiEstim(I0 = sim$I0 , I = sim$res$I_true , #I_obs, #I_true  ,
                                           t_window = t_window,
                                          mean_prior = mean_prior, std_prior = std_prior,
                                          res_EpiEstim = res_EpiEstim, overdispersion = TRUE,
                                          rep = rep, thin = 10, param_agg = TRUE)
