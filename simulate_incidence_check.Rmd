...
diag_plot(I_NB, logged = TRUE, max_x=1, dist = 'poisson', Rt = Rt)
diag_plot(I_NB, logged = FALSE, max_x=.1, dist = 'poisson', Rt = Rt)
...
layout(matrix(1:2, nrow = 1))
diag_plot(I_NB, logged = TRUE, max_x=1, dist = 'nb', Rt = Rt,k = k)
diag_plot(I_NB, logged = FALSE, max_x=.1, dist = 'nb', Rt = Rt, k = k)
...
layout(matrix(1:2, nrow = 1))
diag_plot(I_NB, logged = TRUE, max_x=1, dist = 'poisson', Rt = Rts_P1)
diag_plot(I_NB, logged = FALSE, max_x=.1, dist = 'poisson', Rt = Rts_P1)
...
layout(matrix(1:2, nrow = 1))
diag_plot(I_NB, logged = TRUE, max_x=1, dist = 'nb', Rt = Rts_P1,k = median(res_MCMC_EpiEstim_NB1$theta_over0))
diag_plot(I_NB, logged = FALSE, max_x=.1, dist = 'nb', Rt = Rts_P1, k = median(res_MCMC_EpiEstim_NB1$theta_over0))
...
layout(matrix(1:2, nrow = 1))
diag_plot(I_NB, logged = TRUE, max_x=1, dist = 'nb', Rt = Rts_nb1,k = median(res_MCMC_EpiEstim_NB1$theta_over0))
diag_plot(I_NB, logged = FALSE, max_x=.1, dist = 'nb', Rt = Rts_nb1, k = median(res_MCMC_EpiEstim_NB1$theta_over0))
