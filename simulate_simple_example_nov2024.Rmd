...
res_MCMC_EpiEstim_Poiss2 <- fct_MCMC_EpiEstim(I0_t_import = sim$I0$timespan , I = sim$res$I_true , 
                                              t_window = t_window,
...
res_MCMC_EpiEstim_NB1 <- fct_MCMC_EpiEstim(I0_t_import = sim$I0$timespan , I = sim$res$I_true  ,
                                           t_window = t_window,
                                          mean_prior = mean_prior, std_prior = std_prior,
...
res_MCMC_EpiEstim_NB2 <- fct_MCMC_EpiEstim(I0_t_import = sim$I0$timespan , I = sim$res$I_true  ,
                                           t_window = t_window,
                                          mean_prior = mean_prior, std_prior = std_prior,
                                          res_EpiEstim = res_EpiEstim, overdispersion = TRUE,
                                          rep = rep, thin = 10, param_agg = TRUE, p_reps = input$pi,
