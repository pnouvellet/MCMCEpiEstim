...
resid <- (as.matrix(I_NB[-1,-1])-E_NB[-1,]) /  E_NB[-1,]
...
E_NB_Corr <- E_NB[-1,]*(1 + matrix(Rt$Rt,nrow = nrow(Rt),ncol = ncol(I_NB)-1,byrow = FALSE)/k)
...
plot(log10(c(E_NB[-1,])),c(resid) )
abline(h = 0,col = 'red',lty = 2)
lines(log10(x),y1-x,col = 'red',lty = 1)   
lines(log10(x),y2-x,col = 'red',lty = 1)   
# nbmax
lines(log10(x),(ynb1_max-x),col = 'blue3',lty = 1)
lines(log10(x),(ynb2_max-x),col = 'blue3',lty = 1)
# nbmin
lines(log10(x),(ynb1_max-x),col = 'green4',lty = 1)
lines(log10(x),(ynb2_max-x),col = 'green4',lty = 1)

#
plot((c(E_NB[-1,])),c(resid) , xlim = c(0,max(c(E_NB[-1,]),na.rm = TRUE))*.1  )
abline(h = 0,col = 'red',lty = 2)
lines((x),y1-x,col = 'red',lty = 1)   
lines((x),y2-x,col = 'red',lty = 1)   
# nbmax
lines((x),(ynb1_max-x),col = 'blue3',lty = 1)
lines((x),(ynb2_max-x),col = 'blue3',lty = 1)
# nbmin
lines((x),(ynb1_max-x),col = 'green4',lty = 1)
lines((x),(ynb2_max-x),col = 'green4',lty = 1)

```
```{r}

x_corr1 <- (1+max(Rt$Rt)/k)
x_corr2 <- (1+min(Rt$Rt)/k)

plot(log10(x/x_corr1),y1-x,col = 'red',type = 'l', ylim = c(-1,1)*300)
lines(log10(x/x_corr1),y2-x,col = 'red',type = 'l')

lines(log10(x/x_corr2),y2-x,col = 'orange3',type = 'l')
lines(log10(x/x_corr2),y2-x,col = 'orange3',type = 'l')
