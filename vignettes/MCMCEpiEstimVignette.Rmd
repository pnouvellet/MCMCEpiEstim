...
Rt <- apply(res_MCMC_EpiEstim_NB1$theta_R_thinned,2,median)
D1 <- diag_plot(res = res_EpiEstim,logged = FALSE,max_x = 1,dist = 'NB', k = k, Rt = Rt)
D1$res_table
...
## first prper reporting assumption
