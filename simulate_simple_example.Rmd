...
```{r, eval = FALSE, for list_import}

I <- sim$res$I_obs
I <- list(local = I, import = I)
...
res_MCMC_EpiEstim_NB <- fct_MCMC_EpiEstim(I0_t_import = sim$I0$timespan , 
                                              I = I, #I_true ,
                                              t_window = t_window,
                                              mean_prior = mean_prior, 
                                              std_prior = std_prior,
                                              ...
                                              param_agg = TRUE, 
                                              p_reps = 1,
                                              overlap = FALSE, run_diagnostics = FALSE)


Rt1 <- res_MCMC_EpiEstim_NB$theta_R_thinned
delta <- res_MCMC_EpiEstim_NB$theta_over

plot(apply(Rt1,2,mean))
