...
layout(matrix(1:2, nrow = 1))
diag_plot(I_NB, E_NB, logged = TRUE, max_x=1, dist = 'poisson', Rt = Rt)
diag_plot(I_NB, E_NB, logged = FALSE, max_x=.1, dist = 'poisson', Rt = Rt)

layout(matrix(1:2, nrow = 1))
diag_plot(I_NB, E_NB, logged = TRUE, max_x=1, dist = 'nb', Rt = Rt,k = k)
diag_plot(I_NB, E_NB, logged = FALSE, max_x=.1, dist = 'nb', Rt = Rt, k = k)
